		...
		<div class="col-md-6 col-xl-3">
            <div class="card widget-card-1">
                <div class="card-block-small">
                    ...
                    <h4><?= niara().formatTwoDecimal($this->dashboard_model->getAdminBalance()); ?></h4>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
	        <div class="card widget-card-1">
	            <div class="card-block-small">
	                ...
	                <h4><?= niara().formatTwoDecimal($this->dashboard_model->getAdminUssdCollected(),2); ?></h4>
	            </div>
	        </div>
	    </div>
        <div class="col-md-6 col-xl-3">
            <div class="card widget-card-1">
                <div class="card-block-small">
                    ...
                    <h4><?= niara().formatTwoDecimal($this->dashboard_model->getAdminFeesCollected()); ?></h4>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-3">
            <div class="card widget-card-1">
                <div class="card-block-small">
                    ...
                    <h4><?= formatTwoDecimal($this->dashboard_model->getActiveAgents(),2); ?></h4>
                </div>
            </div>
        </div>
	</div>
