...
<div class="page-body">
    <div class="row">
        ...
        <?php if($_e == 0){ ?>
            <div class="col-md-4">
                <div class="card">
                    <form method="post" action="<?= base_url('banks/save_ussd') ?>" enctype="multipart/form-data">
        ...
        <?php }else{ ?>
            <div class="col-md-4">
                <div class="card">
                    <form method="post" action="<?= base_url('banks/update_ussd') ?>" enctype="multipart/form-data">
                        <div class="card-block">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Name <span class="-req">*</span></label>
                        ...
                        <tbody>
                            <?php foreach ($list as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('banks/edit_ussd/').$value['id'] ?>" class="btn btn-primary btn-mini">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="<?= base_url('banks/delete/').$value['id'] ?>/ussd" class="btn btn-danger btn-mini btn-delete">
